...
itpl RevokePluginAuthorityV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = RevokePluginAuthorityV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
itpl RevokePluginAuthorityV1InstructionData {
    pub fn new() -> Self {
...
pub struct RevokePluginAuthorityV1InstructionArgs {
    pub plugin_type: PluginType,
}

/// Instruction builder for `RevokePluginAuthorityV1`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
#[derive(Default)]
pub struct RevokePluginAuthorityV1Builder {
...
itpl RevokePluginAuthorityV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the asset
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        let accounts = RevokePluginAuthorityV1 {
        ...
        let args = RevokePluginAuthorityV1InstructionArgs {
...
/// `revoke_plugin_authority_v1` CPI accounts.
pub struct RevokePluginAuthorityV1CpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `revoke_plugin_authority_v1` CPI instruction.
pub struct RevokePluginAuthorityV1Cpi<'a, 'b> {
    ...
    pub __args: RevokePluginAuthorityV1InstructionArgs,
}

itpl<'a, 'b> RevokePluginAuthorityV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b trezoa_program::account_info::AccountInfo<'a>,
        accounts: RevokePluginAuthorityV1CpiAccounts<'a, 'b>,
        args: RevokePluginAuthorityV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RevokePluginAuthorityV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   4. `[]` system_program
///   5. `[optional]` log_wrapper
pub struct RevokePluginAuthorityV1CpiBuilder<'a, 'b> {
    instruction: Box<RevokePluginAuthorityV1CpiBuilderInstruction<'a, 'b>>,
}

itpl<'a, 'b> RevokePluginAuthorityV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b trezoa_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RevokePluginAuthorityV1CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = RevokePluginAuthorityV1Cpi {
...
struct RevokePluginAuthorityV1CpiBuilderInstruction<'a, 'b> {
