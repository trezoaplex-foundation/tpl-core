...
pub struct UpdateCollectionInfoV1 {
    ...
    pub bubblegum_signer: trezoa_program::pubkey::Pubkey,
}

itpl UpdateCollectionInfoV1 {
    pub fn instruction(
        &self,
...
itpl UpdateCollectionInfoV1InstructionData {
    pub fn new() -> Self {
...
itpl UpdateCollectionInfoV1Builder {
    ...
    pub fn bubblegum_signer(
        &mut self,
        bubblegum_signer: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
...
pub struct UpdateCollectionInfoV1CpiAccounts<'a, 'b> {
    ...
    /// Bubblegum PDA signer
    pub bubblegum_signer: &'b trezoa_program::account_info::AccountInfo<'a>,
}
...
itpl<'a, 'b> UpdateCollectionInfoV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> UpdateCollectionInfoV1CpiBuilder<'a, 'b> {
    ...
    pub fn bubblegum_signer(
        &mut self,
        bubblegum_signer: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct UpdateCollectionInfoV1CpiBuilderInstruction<'a, 'b> {
    ...
    bubblegum_signer: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    update_type: Option<UpdateType>,
    amount: Option<u32>,
