...
itpl RemoveExternalPluginAdapterV1 {
    pub fn instruction(
        &self,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = RemoveExternalPluginAdapterV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct RemoveExternalPluginAdapterV1InstructionData {
    discriminator: u8,
}

itpl RemoveExternalPluginAdapterV1InstructionData {
    pub fn new() -> Self {
...
pub struct RemoveExternalPluginAdapterV1InstructionArgs {
    pub key: ExternalPluginAdapterKey,
}

/// Instruction builder for `RemoveExternalPluginAdapterV1`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
#[derive(Default)]
pub struct RemoveExternalPluginAdapterV1Builder {
...
itpl RemoveExternalPluginAdapterV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the asset
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        let accounts = RemoveExternalPluginAdapterV1 {
        ...
        let args = RemoveExternalPluginAdapterV1InstructionArgs {
...
/// `remove_external_plugin_adapter_v1` CPI accounts.
pub struct RemoveExternalPluginAdapterV1CpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `remove_external_plugin_adapter_v1` CPI instruction.
pub struct RemoveExternalPluginAdapterV1Cpi<'a, 'b> {
    ...
    pub __args: RemoveExternalPluginAdapterV1InstructionArgs,
}

itpl<'a, 'b> RemoveExternalPluginAdapterV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b trezoa_program::account_info::AccountInfo<'a>,
        accounts: RemoveExternalPluginAdapterV1CpiAccounts<'a, 'b>,
        args: RemoveExternalPluginAdapterV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RemoveExternalPluginAdapterV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   4. `[]` system_program
///   5. `[optional]` log_wrapper
pub struct RemoveExternalPluginAdapterV1CpiBuilder<'a, 'b> {
    instruction: Box<RemoveExternalPluginAdapterV1CpiBuilderInstruction<'a, 'b>>,
}

itpl<'a, 'b> RemoveExternalPluginAdapterV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b trezoa_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RemoveExternalPluginAdapterV1CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            payer: None,
...
struct RemoveExternalPluginAdapterV1CpiBuilderInstruction<'a, 'b> {
