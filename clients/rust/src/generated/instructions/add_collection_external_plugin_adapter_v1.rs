...
itpl AddCollectionExternalPluginAdapterV1 {
    pub fn instruction(
        &self,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddCollectionExternalPluginAdapterV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct AddCollectionExternalPluginAdapterV1InstructionData {
    discriminator: u8,
}

itpl AddCollectionExternalPluginAdapterV1InstructionData {
    pub fn new() -> Self {
...
pub struct AddCollectionExternalPluginAdapterV1InstructionArgs {
    pub init_info: ExternalPluginAdapterInitInfo,
}

/// Instruction builder for `AddCollectionExternalPluginAdapterV1`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct AddCollectionExternalPluginAdapterV1Builder {
...
itpl AddCollectionExternalPluginAdapterV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the asset
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        let accounts = AddCollectionExternalPluginAdapterV1 {
        ...
        let args = AddCollectionExternalPluginAdapterV1InstructionArgs {
...
/// `add_collection_external_plugin_adapter_v1` CPI accounts.
pub struct AddCollectionExternalPluginAdapterV1CpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `add_collection_external_plugin_adapter_v1` CPI instruction.
pub struct AddCollectionExternalPluginAdapterV1Cpi<'a, 'b> {
    ...
    pub __args: AddCollectionExternalPluginAdapterV1InstructionArgs,
}

itpl<'a, 'b> AddCollectionExternalPluginAdapterV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b trezoa_program::account_info::AccountInfo<'a>,
        accounts: AddCollectionExternalPluginAdapterV1CpiAccounts<'a, 'b>,
        args: AddCollectionExternalPluginAdapterV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddCollectionExternalPluginAdapterV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` collection
...
///   3. `[]` system_program
///   4. `[optional]` log_wrapper
pub struct AddCollectionExternalPluginAdapterV1CpiBuilder<'a, 'b> {
    instruction: Box<AddCollectionExternalPluginAdapterV1CpiBuilderInstruction<'a, 'b>>,
}

itpl<'a, 'b> AddCollectionExternalPluginAdapterV1CpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddCollectionExternalPluginAdapterV1Cpi {
...
struct AddCollectionExternalPluginAdapterV1CpiBuilderInstruction<'a, 'b> {
