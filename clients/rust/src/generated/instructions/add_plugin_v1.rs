...
itpl AddPluginV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddPluginV1InstructionData::new().try_to_vec().unwrap();
...
itpl AddPluginV1InstructionData {
    pub fn new() -> Self {
...
/// Instruction builder for `AddPluginV1`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
itpl AddPluginV1Builder {
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        ...
        let args = AddPluginV1InstructionArgs {
...
/// `add_plugin_v1` CPI accounts.
pub struct AddPluginV1CpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `add_plugin_v1` CPI instruction.
pub struct AddPluginV1Cpi<'a, 'b> {
    ...
    pub __args: AddPluginV1InstructionArgs,
}

itpl<'a, 'b> AddPluginV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b trezoa_program::account_info::AccountInfo<'a>,
        accounts: AddPluginV1CpiAccounts<'a, 'b>,
        args: AddPluginV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddPluginV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   4. `[]` system_program
///   5. `[optional]` log_wrapper
pub struct AddPluginV1CpiBuilder<'a, 'b> {
    instruction: Box<AddPluginV1CpiBuilderInstruction<'a, 'b>>,
}

itpl<'a, 'b> AddPluginV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b trezoa_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddPluginV1CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddPluginV1Cpi {
...
struct AddPluginV1CpiBuilderInstruction<'a, 'b> {
