...
pub struct WriteExternalPluginAdapterDataV1 {
    ...
    pub buffer: Option<trezoa_program::pubkey::Pubkey>,
    /// The system program
...
itpl WriteExternalPluginAdapterDataV1 {
    pub fn instruction(
        &self,
...
itpl WriteExternalPluginAdapterDataV1InstructionData {
    pub fn new() -> Self {
...
pub struct WriteExternalPluginAdapterDataV1Builder {
    ...
    buffer: Option<trezoa_program::pubkey::Pubkey>,
...
itpl WriteExternalPluginAdapterDataV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the asset
    ...
    /// The buffer to write to the external plugin
    #[inline(always)]
    pub fn buffer(&mut self, buffer: Option<trezoa_program::pubkey::Pubkey>) -> &mut Self {
        self.buffer = buffer;
        self
    }
...
pub struct WriteExternalPluginAdapterDataV1CpiAccounts<'a, 'b> {
    ...
    /// The buffer to write to the external plugin
    pub buffer: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    /// The system program
...
itpl<'a, 'b> WriteExternalPluginAdapterDataV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> WriteExternalPluginAdapterDataV1CpiBuilder<'a, 'b> {
    ...
    pub fn buffer(
        &mut self,
        buffer: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    ) -> &mut Self {
