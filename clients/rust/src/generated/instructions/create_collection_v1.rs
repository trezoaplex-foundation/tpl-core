...
itpl CreateCollectionV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = CreateCollectionV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
itpl CreateCollectionV1InstructionData {
    pub fn new() -> Self {
...
pub struct CreateCollectionV1InstructionArgs {
    pub name: String,
    pub uri: String,
    pub plugins: Option<Vec<PluginAuthorityPair>>,
}

/// Instruction builder for `CreateCollectionV1`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct CreateCollectionV1Builder {
...
itpl CreateCollectionV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the new asset
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        let accounts = CreateCollectionV1 {
        ...
        let args = CreateCollectionV1InstructionArgs {
...
/// `create_collection_v1` CPI accounts.
pub struct CreateCollectionV1CpiAccounts<'a, 'b> {
    /// The address of the new asset
...
/// `create_collection_v1` CPI instruction.
pub struct CreateCollectionV1Cpi<'a, 'b> {
    ...
    pub __args: CreateCollectionV1InstructionArgs,
}

itpl<'a, 'b> CreateCollectionV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b trezoa_program::account_info::AccountInfo<'a>,
        accounts: CreateCollectionV1CpiAccounts<'a, 'b>,
        args: CreateCollectionV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
///   2. `[writable, signer]` payer
///   3. `[]` system_program
pub struct CreateCollectionV1CpiBuilder<'a, 'b> {
    instruction: Box<CreateCollectionV1CpiBuilderInstruction<'a, 'b>>,
}

itpl<'a, 'b> CreateCollectionV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b trezoa_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreateCollectionV1CpiBuilderInstruction {
            __program: program,
            collection: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CreateCollectionV1Cpi {
...
struct CreateCollectionV1CpiBuilderInstruction<'a, 'b> {
