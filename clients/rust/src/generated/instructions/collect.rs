...
pub struct Collect {
    ...
    pub recipient1: trezoa_program::pubkey::Pubkey,
    /// The address of the recipient 2
    pub recipient2: trezoa_program::pubkey::Pubkey,
}
...
pub struct CollectBuilder {
    recipient1: Option<trezoa_program::pubkey::Pubkey>,
    recipient2: Option<trezoa_program::pubkey::Pubkey>,
...
itpl CollectBuilder {
    ...
    /// The address of the recipient 1
    #[inline(always)]
    pub fn recipient1(&mut self, recipient1: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    /// The address of the recipient 2
    #[inline(always)]
    pub fn recipient2(&mut self, recipient2: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        let accounts = Collect {
            recipient1: self.recipient1.unwrap_or(trezoa_program::pubkey!(
                "8AT6o8Qk5T9QnZvPThMrF9bcCQLTGkyGvVZZzHgCw11v"
            )),
            recipient2: self.recipient2.unwrap_or(trezoa_program::pubkey!(
...
pub struct CollectCpiAccounts<'a, 'b> {
    /// The address of the recipient 1
    pub recipient1: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// The address of the recipient 2
    pub recipient2: &'b trezoa_program::account_info::AccountInfo<'a>,
}
...
itpl<'a, 'b> CollectCpiBuilder<'a, 'b> {
    ...
    pub fn recipient1(
        &mut self,
        recipient1: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn recipient2(
        &mut self,
        recipient2: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct CollectCpiBuilderInstruction<'a, 'b> {
    ...
    recipient1: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    recipient2: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
