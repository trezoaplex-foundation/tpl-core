...
itpl AddExternalPluginAdapterV1 {
    pub fn instruction(
        &self,
        args: AddExternalPluginAdapterV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddExternalPluginAdapterV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct AddExternalPluginAdapterV1InstructionData {
    discriminator: u8,
}

itpl AddExternalPluginAdapterV1InstructionData {
    pub fn new() -> Self {
...
pub struct AddExternalPluginAdapterV1InstructionArgs {
    pub init_info: ExternalPluginAdapterInitInfo,
}

/// Instruction builder for `AddExternalPluginAdapterV1`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
#[derive(Default)]
pub struct AddExternalPluginAdapterV1Builder {
    ...
    init_info: Option<ExternalPluginAdapterInitInfo>,
    __remaining_accounts: Vec<trezoa_program::instruction::AccountMeta>,
}

itpl AddExternalPluginAdapterV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the asset
    ...
    #[inline(always)]
    pub fn init_info(&mut self, init_info: ExternalPluginAdapterInitInfo) -> &mut Self {
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        let accounts = AddExternalPluginAdapterV1 {
        ...
        let args = AddExternalPluginAdapterV1InstructionArgs {
...
/// `add_external_plugin_adapter_v1` CPI accounts.
pub struct AddExternalPluginAdapterV1CpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `add_external_plugin_adapter_v1` CPI instruction.
pub struct AddExternalPluginAdapterV1Cpi<'a, 'b> {
    ...
    pub __args: AddExternalPluginAdapterV1InstructionArgs,
}

itpl<'a, 'b> AddExternalPluginAdapterV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b trezoa_program::account_info::AccountInfo<'a>,
        accounts: AddExternalPluginAdapterV1CpiAccounts<'a, 'b>,
        args: AddExternalPluginAdapterV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddExternalPluginAdapterV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   4. `[]` system_program
///   5. `[optional]` log_wrapper
pub struct AddExternalPluginAdapterV1CpiBuilder<'a, 'b> {
    instruction: Box<AddExternalPluginAdapterV1CpiBuilderInstruction<'a, 'b>>,
}

itpl<'a, 'b> AddExternalPluginAdapterV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b trezoa_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddExternalPluginAdapterV1CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddExternalPluginAdapterV1Cpi {
...
struct AddExternalPluginAdapterV1CpiBuilderInstruction<'a, 'b> {
