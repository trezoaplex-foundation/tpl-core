...
pub struct TransferV1 {
    ...
    pub new_owner: trezoa_program::pubkey::Pubkey,
    /// The system program
...
pub struct TransferV1Builder {
    ...
    new_owner: Option<trezoa_program::pubkey::Pubkey>,
...
itpl TransferV1Builder {
    ...
    /// The new owner to which to transfer the asset
    #[inline(always)]
    pub fn new_owner(&mut self, new_owner: trezoa_program::pubkey::Pubkey) -> &mut Self {
...
pub struct TransferV1CpiAccounts<'a, 'b> {
    ...
    /// The new owner to which to transfer the asset
    pub new_owner: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// The system program
...
itpl<'a, 'b> TransferV1CpiBuilder<'a, 'b> {
    ...
    pub fn new_owner(
        &mut self,
        new_owner: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct TransferV1CpiBuilderInstruction<'a, 'b> {
    ...
    authority: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    new_owner: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    system_program: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    log_wrapper: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    compression_proof: Option<CompressionProof>,
