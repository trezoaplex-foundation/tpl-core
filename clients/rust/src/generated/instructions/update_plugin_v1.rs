...
itpl UpdatePluginV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdatePluginV1InstructionData::new().try_to_vec().unwrap();
...
itpl UpdatePluginV1InstructionData {
    pub fn new() -> Self {
...
/// Instruction builder for `UpdatePluginV1`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
#[derive(Default)]
pub struct UpdatePluginV1Builder {
...
itpl UpdatePluginV1Builder {
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        ...
        let args = UpdatePluginV1InstructionArgs {
...
/// `update_plugin_v1` CPI accounts.
pub struct UpdatePluginV1CpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `update_plugin_v1` CPI instruction.
pub struct UpdatePluginV1Cpi<'a, 'b> {
    ...
    pub __args: UpdatePluginV1InstructionArgs,
}

itpl<'a, 'b> UpdatePluginV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b trezoa_program::account_info::AccountInfo<'a>,
        accounts: UpdatePluginV1CpiAccounts<'a, 'b>,
        args: UpdatePluginV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdatePluginV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   4. `[]` system_program
///   5. `[optional]` log_wrapper
pub struct UpdatePluginV1CpiBuilder<'a, 'b> {
    instruction: Box<UpdatePluginV1CpiBuilderInstruction<'a, 'b>>,
}

itpl<'a, 'b> UpdatePluginV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b trezoa_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdatePluginV1CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdatePluginV1Cpi {
...
struct UpdatePluginV1CpiBuilderInstruction<'a, 'b> {
