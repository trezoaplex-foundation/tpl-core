...
itpl CreateCollectionV2InstructionData {
    pub fn new() -> Self {
...
itpl CreateCollectionV2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the new asset
...
itpl<'a, 'b> CreateCollectionV2Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> CreateCollectionV2CpiBuilder<'a, 'b> {
