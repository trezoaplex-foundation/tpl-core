...
itpl UpdateCollectionPluginV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdateCollectionPluginV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
itpl UpdateCollectionPluginV1InstructionData {
    pub fn new() -> Self {
...
pub struct UpdateCollectionPluginV1InstructionArgs {
    pub plugin: Plugin,
}

/// Instruction builder for `UpdateCollectionPluginV1`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct UpdateCollectionPluginV1Builder {
...
itpl UpdateCollectionPluginV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the asset
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        let accounts = UpdateCollectionPluginV1 {
        ...
        let args = UpdateCollectionPluginV1InstructionArgs {
...
/// `update_collection_plugin_v1` CPI accounts.
pub struct UpdateCollectionPluginV1CpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `update_collection_plugin_v1` CPI instruction.
pub struct UpdateCollectionPluginV1Cpi<'a, 'b> {
    ...
    pub __args: UpdateCollectionPluginV1InstructionArgs,
}

itpl<'a, 'b> UpdateCollectionPluginV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b trezoa_program::account_info::AccountInfo<'a>,
        accounts: UpdateCollectionPluginV1CpiAccounts<'a, 'b>,
        args: UpdateCollectionPluginV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdateCollectionPluginV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` collection
...
///   3. `[]` system_program
///   4. `[optional]` log_wrapper
pub struct UpdateCollectionPluginV1CpiBuilder<'a, 'b> {
    instruction: Box<UpdateCollectionPluginV1CpiBuilderInstruction<'a, 'b>>,
}

itpl<'a, 'b> UpdateCollectionPluginV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b trezoa_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdateCollectionPluginV1CpiBuilderInstruction {
            __program: program,
            collection: None,
            payer: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdateCollectionPluginV1Cpi {
...
struct UpdateCollectionPluginV1CpiBuilderInstruction<'a, 'b> {
