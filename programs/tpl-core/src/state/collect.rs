use trezoa_program::{program_error::ProgramError, pubkey::Pubkey, rent::Rent, sysvar::Sysvar};

use crate::error::MplCoreError;

pub(crate) const COLLECT_RECIPIENT1: Pubkey =
    trezoa_program::pubkey!("8AT6o8Qk5T9QnZvPThMrF9bcCQLTGkyGvVZZzHgCw11v");

pub(crate) const COLLECT_RECIPIENT2: Pubkey =
    trezoa_program::pubkey!("MmHsqX4LxTfifxoH8BVRLUKrwDn1LPCac6YcCZTHhwt");
