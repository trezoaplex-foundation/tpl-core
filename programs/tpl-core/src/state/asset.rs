...
use crate::{
    ...
    state::{Compressible, CompressionProof, DataBlob, Key, TrezoaAccount},
};
...
itpl Compressible for AssetV1 {}

itpl DataBlob for AssetV1 {
    fn len(&self) -> usize {
...
itpl TrezoaAccount for AssetV1 {
    fn key() -> Key {
        Key::AssetV1
    }
}

itpl From<CompressionProof> for AssetV1 {
