...
use crate::{
    ...
    state::{AssetV1, Authority, CoreAsset, DataBlob, Key, TrezoaAccount},
...
pub fn create_meta_idempotent<'a, T: TrezoaAccount + DataBlob>(
...
pub fn create_plugin_meta<'a, T: TrezoaAccount + DataBlob>(
    asset: &T,
    account: &AccountInfo<'a>,
    payer: &AccountInfo<'a>,
    system_program: &AccountInfo<'a>,
...
pub fn fetch_plugin<T: DataBlob + TrezoaAccount, U: BorshDeserialize>(
    account: &AccountInfo,
...
/// Fetch the plugin from the registry.
pub fn fetch_wrapped_plugin<T: DataBlob + TrezoaAccount>(
    account: &AccountInfo,
    core: Option<&T>,
    plugin_type: PluginType,
...
pub fn list_plugins<T: DataBlob + TrezoaAccount>(
    account: &AccountInfo,
...
pub fn initialize_plugin<'a, T: DataBlob + TrezoaAccount>(
    plugin: &Plugin,
    authority: &Authority,
    header_offset: usize,
...
#[allow(clippy::too_many_arguments)]
pub fn initialize_external_plugin_adapter<'a, T: DataBlob + TrezoaAccount>(
...
/// Add an external plugin adapter to the registry and initialize it.
#[allow(clippy::too_many_arguments)]
pub fn update_external_plugin_adapter_data<'a, T: DataBlob + TrezoaAccount>(
