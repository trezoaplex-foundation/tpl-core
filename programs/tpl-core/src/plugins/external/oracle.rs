...
itpl PluginValidation for Oracle {
...
itpl From<&OracleInitInfo> for Oracle {
...
pub enum ValidationResultsOffset {
    ...
    NoOffset,
    /// The Oracle is an Trezoa account so the validation struct is located after an 8-byte
...
itpl OracleValidation {
    /// Borsh- and Trezoa-serialized size of the `OracleValidation` struct.
