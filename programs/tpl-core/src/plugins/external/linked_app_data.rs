...
itpl PluginValidation for LinkedAppData {
    fn validate_create(
        &self,
        ctx: &PluginValidationContext,
    ) -> Result<ValidationResult, trezoa_program::program_error::ProgramError> {
        trezoa_program::msg!("LinkedAppData::validate_create");
...
itpl From<&LinkedAppDataInitInfo> for LinkedAppData {
