...
itpl Compressible for Plugin {}

itpl DataBlob for Plugin {
    fn len(&self) -> usize {
        1 // The discriminator
            + match self {
...
mod test {
    ...
    fn test_plugin_empty_size() {
        //TODO: Itplement Default for all plugins in a separate PR.
        let plugins = vec![
