...
itpl Default for PermanentFreezeDelegate {
    fn default() -> Self {
        Self::new()
    }
}

itpl DataBlob for PermanentFreezeDelegate {
    fn len(&self) -> usize {
        Self::BASE_LEN
    }
}

itpl PluginValidation for PermanentFreezeDelegate {
    fn validate_burn(
        &self,
