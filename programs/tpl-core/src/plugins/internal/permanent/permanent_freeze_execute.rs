...
itpl Default for PermanentFreezeExecute {
    fn default() -> Self {
        Self::new()
    }
}

itpl DataBlob for PermanentFreezeExecute {
    fn len(&self) -> usize {
        Self::BASE_LEN
    }
}

itpl PluginValidation for PermanentFreezeExecute {
