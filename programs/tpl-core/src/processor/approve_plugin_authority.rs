...
use trezoa_program::{account_info::AccountInfo, entrypoint::ProgramResult, msg};
...
use crate::{
    ...
    state::{AssetV1, Authority, CollectionV1, CoreAsset, DataBlob, Key, TrezoaAccount},
    utils::{
...
fn process_approve_plugin_authority<'a, T: CoreAsset + DataBlob + TrezoaAccount>(
