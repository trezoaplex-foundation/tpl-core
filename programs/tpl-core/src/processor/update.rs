...
use crate::{
    ...
    state::{AssetV1, CollectionV1, DataBlob, Key, TrezoaAccount, UpdateAuthority},
    utils::{
...
itpl From<UpdateV1Args> for UpdateV2Args {
            ...
            match ix_version {
                ...
                InstructionVersion::V2 => {
                    ...
                    if plugin_set.contains(&PluginType::UpdateDelegate) {
                        ...
                        {
                            trezoa_program::msg!("UA: Rejected");
...
fn process_update<'a, T: DataBlob + TrezoaAccount>(
    core: T,
