...
use crate::{
    ...
    state::{
        get_create_fee, AssetV1, Authority, CollectionV1, DataState, TrezoaAccount, UpdateAuthority,
    },
...
itpl From<CreateV1Args> for CreateV2Args {
...
pub(crate) fn process_create<'a>(
    ...
    let serialized_data = match args.data_state {
        ...
        DataState::LedgerState => {
            // TODO: Itplement minting compressed.
            trezoa_program::msg!("Error: Minting compressed is currently not available");
