...
use crate::{
    ...
    state::{
        AssetV1, Authority, CollectionV1, CoreAsset, DataBlob, Key, TrezoaAccount, UpdateAuthority,
    },
};
...
pub fn fetch_core_data<T: DataBlob + TrezoaAccount>(
    account: &AccountInfo,
...
#[allow(clippy::type_cotplexity, clippy::too_many_arguments)]
